...
class ObjectsMetaData:
    ...
    def __init__(self,image_id,detr_model_data):
        ...
        self.metadata = {
            image_id:{
                "labels": detr_model_data[image_id]["image_labels"]
            }
        }
    ...
    def object_count(self):
        ...
        self.metadata[self.detected_image_id]["objects_count"] = total_objects
    ...
    def object_location(self):
        ...
        self.metadata[self.detected_image_id["intersection_points"]] = intersections
...
def process_data():
    ...
    for image_name in args.sketch_image_data:
        ...
        if detected_image_data !=[]:
            ...
            object_metadata = ObjectsMetaData(image_id,detected_image_data[0])
